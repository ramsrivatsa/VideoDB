...
public class E4_SequentialFeaturesTopology {
	...
	public static void main(String[] args){
		...
		conf.setNumWorkers(32); // number of workers in the topology
		...
		builder.setSpout("spout", new CVParticleSpout( new FileFrameFetcher(files).frameSkip(frameSkip) ), 4 );
		...
		builder.setBolt("fat_features", new SingleInputBolt( new SequentialFrameOp(operations).outputFrame(true).retainImage(true)), 12)
